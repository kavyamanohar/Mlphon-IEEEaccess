...
Inherent vowel {\ipa /a/} is added after consonant phonemes if it is at the end of a syllable position, or it is followed by the anuswara, visarga, or a chillu as described in Algorithm \ref{disambiguation}.
...
The composition of the series of FSTs from \ref{normalisation} to \ref{syllabletagger} results in a very useful module that performs syllabification of Malayalam text. We compose these FSTs to get the Syllabifier FST and provide programmable access to it in the Mlphon Python library. This module has interesting applications like developing subword level language modelling for ASR as described in section \ref{applications}. An illustration of this module accepting Malayalam text as input and generating output with syllable boundary tags is shown in Fig. \ref{syllabifierblock}.
